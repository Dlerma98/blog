<header class="bg-white px-6 shadow dark:bg-slate-900">
        ...
        <div class="flex">
            ...
            >
                <img
                    ...
                    src="https://ui-avatars.com/api?name=David+Lerma"
                    alt="David Lerma"
                />
            </button>
        </div>
    ...
    >
        <a
            href="{{route('home')}}"
            class="block rounded-md bg-sky-500 px-3 py-2 {{request()->routeIs('home') ? 'bg-sky-500 text-white' : 'text-slate-700 transition-colors hover:bg-sky-500 dark:text-slate-400 dark:hover:text-white'}}"
        >
            Home
        </a>
        ...
        <a
            href="{{route('posts.index')}}"
            class="block rounded-md px-3 py-2 {{request()->routeIs('posts.*') ? 'bg-sky-500 text-white' : 'text-slate-700 transition-colors hover:bg-sky-500 dark:text-slate-400 dark:hover:text-white'}}"
        >
            Blog
        </a>
        ...
        <a
            href="{{route('about')}}"
            class="block rounded-md px-3 py-2 {{request()->routeIs('about') ? 'bg-sky-500 text-white' : 'text-slate-700 transition-colors hover:bg-sky-500 dark:text-slate-400 dark:hover:text-white'}}"
        >
            About
        </a>
        ...
        <a
            href="{{route('contact')}}"
            class="block rounded-md px-3 py-2 {{request()->routeIs('contact') ? 'bg-sky-500 text-white' : 'text-slate-700 transition-colors hover:bg-sky-500 dark:text-slate-400 dark:hover:text-white'}}"
        >
            Contact
        </a>
    </div>
